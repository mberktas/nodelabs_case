...
@override
String toString() {
  return 'LoginResponse(id: $id, name: $name, email: $email, photoUrl: $photoUrl, token: $token)';
}
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({required this.id, required this.name, required this.email, this.photoUrl, required this.token});
